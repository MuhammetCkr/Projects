...
namespace MiniShop.Web.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> PasswordEdit(PasswordModel passwordModel)
        {
            ...
            if (result.Succeeded)
            {
                TempData["AlertMessage"]=Jobs.CreateMessage("Başarılı", "Şifre deiştirildi", "success");
                return RedirectToAction("UserList");
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        TempData["AlertMessage"] = Jobs.CreateMessage("Tebrikler!", "Kayıt başarıyla değiştirilmiştir.", "success");
                        return RedirectToAction("UserList");
                    }
                    foreach (var error in result.Errors)
                    {
